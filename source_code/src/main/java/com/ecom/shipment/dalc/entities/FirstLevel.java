...
@Entity
@Table(name = "tbl_first_levels")
@NoArgsConstructor
public class FirstLevel {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_first_level", updatable = false, nullable = false, unique = true)
    private Long idFirstLevel;
    ...
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "firstLevel")
    private ShipmentCharge shipmentCharge;


    public Long getIdFirstLevel() {
        return idFirstLevel;
    }

    public void setIdFirstLevel(Long idFirstLevel) {
